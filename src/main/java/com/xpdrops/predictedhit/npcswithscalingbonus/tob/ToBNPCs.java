...
public enum ToBNPCs
{
	...
	NYLOCAS_VASILIAS(	new ToBNPC(1.175,	1.2, 	1.225	), NpcID.NYLOCAS_VASILIAS_8355, NpcID.NYLOCAS_VASILIAS_8356, NpcID.NYLOCAS_VASILIAS_8357),
	SOTETSEG(			new ToBNPC(1.525,	1.6, 	1.675	), NpcID.SOTETSEG_8388),
	VERZIK_P1(			new ToBNPC(1.05,	1.05, 	1.05	), NpcID.VERZIK_VITUR_8370, NpcID.VERZIK_VITUR_8371),
	VERZIK_P2(			new ToBNPC(1.375,	1.425, 	1.45	), NpcID.VERZIK_VITUR_8372, NpcID.VERZIK_VITUR_8373),
	VERZIK_P3(			new ToBNPC(1.7,	1.8, 	1.9		), NpcID.VERZIK_VITUR_8374, NpcID.VERZIK_VITUR_8375),
	// TOB HM
	BLOAT_HM(			new ToBNPC(1.8, 	1.9, 	1.975	), NpcID.PESTILENT_BLOAT_10813),
	NYLOCAS_VASILIAS_HM(new ToBNPC(1.175,	1.2, 	1.225	), NpcID.NYLOCAS_VASILIAS_10808, NpcID.NYLOCAS_VASILIAS_10809, NpcID.NYLOCAS_VASILIAS_10810),
	SOTETSEG_HM(		new ToBNPC(1.525,	1.6, 	1.675	), NpcID.SOTETSEG_10868),
	VERZIK_P1_HM(		new ToBNPC(1.05,	1.05, 	1.05	), NpcID.VERZIK_VITUR_10848, NpcID.VERZIK_VITUR_10849),
	VERZIK_P2_HM(		new ToBNPC(1.375,	1.425, 	1.45	), NpcID.VERZIK_VITUR_10850, NpcID.VERZIK_VITUR_10851),
	VERZIK_P3_HM(		new ToBNPC(1.7,	1.8, 	1.9		), NpcID.VERZIK_VITUR_10852, NpcID.VERZIK_VITUR_10853),
	;
